...
namespace Azure.ResourceManager.DigitalTwins
{
    ...
    public partial class DigitalTwinsEndpointClient
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly HttpPipeline _pipeline;
        internal DigitalTwinsEndpointRestClient RestClient { get; }
        /// <summary> Initializes a new instance of DigitalTwinsEndpointClient for mocking. </summary>
        protected DigitalTwinsEndpointClient()
        {
        }
        /// <summary> Initializes a new instance of DigitalTwinsEndpointClient. </summary>
        /// <param name="clientDiagnostics"> The handler for diagnostic messaging in the client. </param>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="subscriptionId"> The subscription identifier. </param>
        /// <param name="endpoint"> server parameter. </param>
        /// <param name="apiVersion"> Api Version. </param>
        internal DigitalTwinsEndpointClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-03-01-preview")
        {
            RestClient = new DigitalTwinsEndpointRestClient(clientDiagnostics, pipeline, subscriptionId, endpoint, apiVersion);
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("DigitalTwinsEndpointClient.Get");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<DigitalTwinsEndpointResource> ListAsync(string resourceGroupName, string resourceName, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("DigitalTwinsEndpointClient.List");
                scope.Start();
                try
                {
        ...
        public virtual async Task<DigitalTwinsEndpointCreateOrUpdateOperation> StartCreateOrUpdateAsync(string resourceGroupName, string resourceName, string endpointName, DigitalTwinsEndpointResourceProperties properties = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("DigitalTwinsEndpointClient.StartCreateOrUpdate");
            scope.Start();
            try
            {
        ...
        public virtual async Task<DigitalTwinsEndpointDeleteOperation> StartDeleteAsync(string resourceGroupName, string resourceName, string endpointName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("DigitalTwinsEndpointClient.StartDelete");
            scope.Start();
            try
            {
